...
interface IERC726 { 
    ...
    */
     ...
     *        dividend distributed must not exceeds a certain amount of ether.
     *      - The token must be transferred to a pre-set unified address when refund succeeds.
     ...
     * @dev - Caller should normally have been bound to a certain account for inflowing ether. Received
     *        ether value is added to the balance of the bound account if caller is bounded, otherwise
     ...
     * @param receiver: address of which ether outflows to. 'receiver' must be pre-bound to a certain
     *        account for outflowing ether. Outflowed ether value is deducted from the balance of its
     *        bound account.
     ...
     * @dev - Caller should normally be bound to a certain account for inflowing asset. Received asset
     *        value is added to the balance of the bound account if caller is bound istered, otherwise
     *        to a default account.
     ...
     * @param receiver: address of which asset outflows to. 'receiver' must be pre-bound to a certain
     *        account for outflowing asset. outflowed asset value is deducted from the balance of its
     *        bound account.
     ...
     * @dev - Caller MUST be the contract owner or an authorized operator.
     *      - Implemetation of certain rules to determine who will be entitled to the royalty distribution.
     */        
     ...
     * @dev - Caller MUST be the contract owner or an authorized operator.
     *      - Implemetation of certain rules to determine who will be entitled to the dividend distribution.
     */      
...
Asset inflow sources and outflow receivers need to be binded to a certain account for asset inflowing and outflowing to be recorded to the right account, and more importantly, this can enchance the security of the asset inflow.
